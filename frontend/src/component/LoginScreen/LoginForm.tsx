...
export class LoginForm extends React.PureComponent<LoginFormProps, State> {
	...
	private renderLogin(): JSX.Element {
		return (
			<FormControl>
					<TextField label="Email" style={{marginTop: 50}} name="email" type="email" value={this.state.email} onChange={this.updateEmail}/>
					<TextField label="Password" type="password" name="password" value={this.state.password} onChange={this.updatePassword}/>
					<Button
						color="primary"
						variant="raised"
						style={{margin: 20}}
